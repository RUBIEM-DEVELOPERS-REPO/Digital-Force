      ...
      <main className="flex-1 overflow-y-auto" style={{ background: '#080B12' }}>
        ...
        <div style={{ padding: '2.5rem 3rem' }}>
          ...
          <motion.div variants={stagger.container} initial="hidden" animate="show"
            ...
            {[
              { label: 'Active Directives', value: activeGoals.length, icon: Target, color: '#00A3FF', glow: 'rgba(0,163,255,0.1)' },
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
              <h2 style={{ fontSize: '1rem', fontWeight: 700, color: '#F8FAFC', letterSpacing: '-0.01em' }}>Active Directives</h2>
            ...
            {loading ? (
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F8FAFC', marginBottom: '0.75rem', letterSpacing: '-0.01em' }}>No Active Directives</h3>
                <p style={{ fontSize: '0.875rem', color: '#475569', maxWidth: 380, lineHeight: 1.7, marginBottom: '2rem' }}>
                  Deploy a directive and watch the neural agents autonomously synthesize and execute a complete strategy.
                </p>
                <Link href="/goals/new" style={{
                  ...
                  <Plus size={16} /> Deploy First Directive
                </Link>
              </div>
            ) : (
